#!/bin/bash
# Compila gpu-split/qmccluster_pipeline -- produccion actual pero con
# derananum partido en 3 kernels (He4 / resto / cierre) lanzados en
# streams concurrentes, en vez de una sola llamada a derananum() dentro
# de k_derananum_t. Ver derananum_split_mod.cuf.
set -e
cd "$(dirname "$0")/gpu-split"
...
echo "OK: qmccluster_pipeline (gpu-split)"

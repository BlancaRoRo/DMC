#!/bin/bash
# Compila gpu-pow-rapido/qmccluster_pipeline -- copia aislada de
# hibrido_instrumentado con mypow sustituida por la intrinseca nativa
# de CUDA (ver glibc_pow.cuf). No toca ningun binario validado.
set -e
cd "$(dirname "$0")/gpu-pow-rapido"
...
echo "OK: qmccluster_pipeline (gpu-pow-rapido)"

#!/bin/bash
# Compila gpu-he_dihydrogen-optimizado/qmccluster_pipeline -- copia
# aislada con He_dihydrogen.f fusionando dispersion+induccion en un
# solo DO y usando mypow_log/mypow_desde_log para mycos(theta)/
# mysin(theta)/rnorm. No toca hibrido_instrumentado real.
set -e
cd "$(dirname "$0")/gpu-he_dihydrogen-optimizado"
...
echo "OK: qmccluster_pipeline (gpu-he_dihydrogen-optimizado)"

#!/bin/bash
# Compila gpu-myexp-optimizado/qmccluster_pipeline -- copia aislada con
# FN1/DFN1/FN2/DFN2 compartiendo F00(x)=myexp(-x) (calculado 1 vez en
# vez de 7/3 veces) y Ex0/Ey0/Ez0/dExdx...dEzdz reutilizando
# fn2_rh1/fn2_rh2/fn2_r0 en vez de llamar a FN2 repetidamente. No toca
# hibrido_instrumentado real.
set -e
cd "$(dirname "$0")/gpu-myexp-optimizado"
...
echo "OK: qmccluster_pipeline (gpu-myexp-optimizado)"

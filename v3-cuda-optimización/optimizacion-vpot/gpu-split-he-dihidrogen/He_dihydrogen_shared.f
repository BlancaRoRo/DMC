...
C  myexp-optimizacion.md antes de usarse aqui.
     ...
     &                          ENERGY2, ENERGY3)
      ...
      use mFN1, only: FN1
      use mterminodispersion, only: termino_dispersion_shared
...
C  una llamaba a mypow por separado con el mismo (base,exponente)).
       call termino_dispersion_shared(theta, rnorm, eterm1, eterm2,
     &     coshi, coslo, sinhi, sinlo, normhi, normlo, atheta,
     &     btheta, c6theta, norm6)

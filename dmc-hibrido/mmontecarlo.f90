...
! ---- dmc_gpu_pipeline (opcion=5): mismo esqueleto que dmc, con pasodmc
! sustituido por pasodmc_gpu_pipeline (msteps.f90, Opcion 1 de
! arquitectura-streams-kin-pot.md Parte 12-13). dmc original (arriba)
! no se toca.
 subroutine dmc_gpu_pipeline
  ...
  real(kind=r8) :: denb_local
   ...
   write(*,'(a,f12.4,a)') ' tiempo total opcion5 (pipeline): ', t_total7, ' s'
   call tiempos_escribe7('tiempos_opcion5.dat')

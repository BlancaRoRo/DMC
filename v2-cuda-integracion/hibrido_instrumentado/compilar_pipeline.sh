#!/bin/bash
# Compila el binario instrumentado con la Opcion 1 (pipeline de 7 fases
# + CUDA Graph, opcion=7) anadida. No toca compilar.sh/qmccluster_tiempos
# original -- genera un binario distinto (qmccluster_pipeline) para

#!/bin/bash
# Compila gpu-sin-fusion/qmccluster_pipeline -- produccion actual pero
# con derananum llamando a wavefhe4+derwavefhe4 SIN fusionar (en vez de
# wavef_derwavefhe4), para medir si la fusion esta costando mas
# registros/ocupacion de lo que ahorra en computo. Copia aislada, no
# toca produccion.
set -e
cd "$(dirname "$0")/gpu-sin-fusion"
...
echo "OK: qmccluster_pipeline (gpu-sin-fusion)"

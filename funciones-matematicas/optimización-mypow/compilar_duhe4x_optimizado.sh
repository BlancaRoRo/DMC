#!/bin/bash
# Compila gpu-duhe4x-optimizado/qmccluster_pipeline -- copia aislada
# con duhe4x/uhe4x usando mypow_log/mypow_desde_log en vez de mypow
# directa. No toca hibrido_instrumentado real.
set -e
cd "$(dirname "$0")/gpu-duhe4x-optimizado"
...
echo "OK: qmccluster_pipeline (gpu-duhe4x-optimizado)"

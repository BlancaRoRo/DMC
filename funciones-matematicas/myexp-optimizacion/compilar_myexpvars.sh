#!/bin/bash
# Compila gpu-gtest-fijo-mas-a-mas-nhe3fijo-mas-myexpvars/qmccluster_pipeline
# -- GTEST fijo + (a) + nhe3 fijo + punto 2 (eliminar z/topbits, variables
# de un solo uso, en myexp).
set -e
cd "$(dirname "$0")/gpu-gtest-fijo-mas-a-mas-nhe3fijo-mas-myexpvars"
...
echo "OK: qmccluster_pipeline (myexpvars)"

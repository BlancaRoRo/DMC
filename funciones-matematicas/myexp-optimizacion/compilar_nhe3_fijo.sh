#!/bin/bash
# Compila gpu-gtest-fijo-mas-a-mas-nhe3fijo/qmccluster_pipeline --
# GTEST fijo + cambio (a) + nhe3 fijo como PARAMETER=0 (sin (b), que
# quedo descartada por la regresion sin explicar de la seccion 9.6).
set -e
cd "$(dirname "$0")/gpu-gtest-fijo-mas-a-mas-nhe3fijo"
...
echo "OK: qmccluster_pipeline (gpu-gtest-fijo-mas-a-mas-nhe3fijo)"

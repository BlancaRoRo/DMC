#!/bin/bash
# Compila gpu-semilla-alineada/qmccluster_pipeline -- produccion actual
# pero con k_split_seeds usando (iw-1) avances de rand1p_gpu en vez de
# (iw), para que el walker 1 use la semilla maestra sin avance extra,
# igual que la CPU. Ver alineacion-semilla-walker1.md.
set -e
cd "$(dirname "$0")/gpu-semilla-alineada"
...
echo "OK: qmccluster_pipeline (gpu-semilla-alineada)"
